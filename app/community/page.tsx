...
export default function CommunityPage() {
  const [posts] = useState([
    {
      id: 1,
      user: { name: "Mihaaa", avatar: "/diverse-user-avatars.png", subtitle: "今年も来ました！Disney!!ゆうチとかわいい後輩三人と♡♡♡夏の日差しがまぶしかったぁぁ🌥お日様たくさん浴びて心地の良いでずにでした！！みんなでおそろっちの服装可愛すぎマシュ///（私が一番似合ってたけどネ（自分で言うな））次は10月末の学校が休みの日に行く約束をしたじょぉ(^^）/その前に彼ぴとも行くから金欠確定ナリ;;" },
      image: "/IMG_0438.jpg",
      likes: 12,
    },
    {
